...
pub use schema::{
    ...
    PermissionsConfig, Pricing, SecretStoreKind, ShellConfig, ThinkingDisplay, ToolTimeouts,
    ToolsConfig, TraceConfig, WORKSPACE_OVERRIDABLE, default_pricing, workspace_overridable,
};
