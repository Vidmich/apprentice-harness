...
pub use schema::{
    ...
    PermissionsConfig, Pricing, RuntimeConfig, SecretStoreKind, ShellConfig, ThinkingDisplay,
    ToolTimeouts, ToolsConfig, TraceConfig, WORKSPACE_OVERRIDABLE, default_pricing,
