...
pub use schema::{
    ApprenticeConfig, Config, DaemonConfig, ENV_OVERRIDES, Headless, MentorConfig,
    PermissionsConfig, Pricing, RuntimeConfig, SecretStoreKind, SessionsConfig, ShellConfig,
    ThinkingDisplay, ToolTimeouts, ToolsConfig, TraceConfig, WORKSPACE_OVERRIDABLE,
    default_pricing, workspace_overridable,
};
