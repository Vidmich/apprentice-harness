...
| M04-09 | Base model selection run | Using M02 models and M03 prompted roles, run replay + bench across candidate base models/quants; produce the report that fixes the default base model (SPEC §17 deferred decision). |
